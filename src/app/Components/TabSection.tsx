...
const TabSection = ({
  ...
  return (
    <div className="flex flex-col bg-white  p-3 rounded-2xl shadow-sm gap-2 sm:px-5 md:col-span-1 md:min-w-[407px] h-full">
      ...
      <button
        className="fixed bottom-6 right-6 custom-gradient text-white rounded-xl text-sm py-2 px-3 flex items-center gap-2 shadow-lg hover:bg-[#d81b60] transition-colors z-50"
        onClick={() => setActiveTab("Reviews")}
      >
